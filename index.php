...
<body>
		        ...
		        <div class="row">	        		
		            ...
		            <div class="collapse navbar-collapse">
		                <ul class="nav navbar-nav navbar-right">                 
		                    ...
		                    <li class="scroll"><a href="#event-history" >Events History</a></li>
		                    <li class="scroll"><a href="#score-submission" >Score Submission</a></li>
		...
		<div id="main-slider" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img class="img-responsive" src="images/slider/bg11.jpg" alt="slider">						
					<div class="carousel-caption">
						<h2>register for our next event </h2>
					</div>
				</div>
				<div class="item">
					<img class="img-responsive" src="images/slider/bg22.jpg" alt="slider">	
					<div class="carousel-caption">
						<h2>register for our next event </h2>
					</div>
				</div>
				<div class="item">
					<img class="img-responsive" src="images/slider/bg33.jpg" alt="slider">	
					<div class="carousel-caption">
						<h2>register for our next event </h2>
					</div>
				</div>				
	...
	<section id="explore">
		<div class="container">
			...
			<div class="cart">
				<a href="#"><i class="fa fa-angle-left"></i> <span>Join this event</span></a>
				<a href="#"><i class="fa fa-angle-left"></i> <span>Create a new event</span></a>
			</div>
		</div>
	</section><!--/#explore-->
	...
	<section id="event">
		<div class="container">
								...
								<div class="row">
									<div class="col-sm-4">
										<div class="single-event">
											<img class="img-responsive" src="images/event/e1.jpg" alt="event-image">
									...
									<div class="col-sm-4">
										<div class="single-event">
											<img class="img-responsive" src="images/event/e2.jpg" alt="event-image">
											<h4>Team A vs Team B</h4>
											<h5>hu 12/22 2PM</h5>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="single-event">
											<img class="img-responsive" src="images/event/e3.jpg" alt="event-image">
											<h4>Team A vs Team B</h4>
											<h5>Thu 12/22 2PM</h5>
										</div>
									</div>
			...
			<div class="cart">
				<a href="#"><i class="fa fa-angle-left"></i> <span>Upcoming eventlist</span></a>
			</div>
		</div>
	</section><!--/#event-->
	...
	<section id="about">
		<div class="guitar2">				
			<img class="img-responsive" src="images/downloads/logo.jpg" alt="guitar">
		</div>
		<div class="about-content">					
					<h2>About Go!Play.</h2>
					<p>“Go!Play.” is designed as a brand new, independent system that is completely self-contained. This release of the system will be the very first version, that is v1.0</p>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-10">
						...
						<div class="carousel-inner">
							<p> We are looking for sponsers!!</p>
							<p> Interested ???? Please contzct us!</p>
							<br>
							<br>
							<br>
							<br><br><br><br><br><br>
